...
$row2=$res2->fetch_row();
   ...
   if($amt > $row1['5'])
  {
   ...
   else
    {
       ...
       $sac = $row1['1'];
       $rac = $row2['1'];
       $linknew=new mysqli("localhost","root","","ssf") or die("DATA NOT FOUND");
    ...
    .msg
 {
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-lg mb-3">
    ...
    <a href="#" class="navbar-brand">
      <!-- Logo Image -->
      <img src="ssfbank.jpg" width="40" alt="" class="d-inline-block align-left mr-2">
      <!-- Logo Text -->
  ...
  <?php
  $link1=new mysqli("localhost","root","","ssf") or die("DATA NOT FOUND");
  ...
  <div class="card border-dark" style="width: 25rem ;background-color:#997a8d">
    <div class="card-body">
  ...
  $link2=new mysqli("localhost","root","","ssf") or die("DATA NOT FOUND");
